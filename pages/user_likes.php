...
<section class="posts-container">
   ...
   <div class="box-container">
      <?php
      $select_likes = $conn->prepare("SELECT post_id FROM `likes` WHERE user_id = ?");
      ...
      if ($select_likes->rowCount() > 0) {
         while ($fetch_likes = $select_likes->fetch(PDO::FETCH_ASSOC)) {
            ...
            $select_posts->execute([$fetch_likes['post_id'], 'active']);
      ...
      <form class="box" method="post">
         ...
         <div class="icons">
            ...
            <button type="submit" name="like_post"><i class="fas fa-heart" style="color:red;"></i><span>(<?= $total_post_likes; ?>)</span></button>
         </div>
      </form>
      <?php
               }
